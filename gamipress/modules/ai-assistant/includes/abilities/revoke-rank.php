 ...
 * Revoke Rank Ability
 *
 * @package     GamiPress\AI_Assistant\Ability\Revoke_Rank
...
class GamiPress_AI_Assistant_Ability_Revoke_Rank extends GamiPress_AI_Assistant_Ability {

    public $ability = 'revoke-rank';
    ...
    public function register() {
        ...
        $this->args = array(
            'label'               => __( 'Revoke a rank in GamiPress', 'gamipress' ),
            'description'         => __( 'Revokes a specific rank to a user. Requires the user, the rank type, and the rank to award.', 'gamipress' ),
            'input_schema'        => array(
                'type'       => 'object',
                'properties' => array(
                    'user' => array(
    ...
    public function execute( $args ) {
        ...
        // Revoke the rank from the user
        gamipress_revoke_rank_to_user( $user->ID, $rank->ID );
...
new GamiPress_AI_Assistant_Ability_Revoke_Rank();