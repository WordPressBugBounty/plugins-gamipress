<?php
/**
 * Award Achievement Ability
 *
 * @package     GamiPress\AI_Assistant\Ability\Award_Achievement
...
class GamiPress_AI_Assistant_Ability_Award_Achievement extends GamiPress_AI_Assistant_Ability {

    public $ability = 'award-achievement';
    ...
    public function register() {
        ...
        $this->args = array(
            'label'               => __( 'Award an achievement in GamiPress', 'gamipress' ),
            'description'         => __( 'Awards a specific achievement to a user. Requires the user, the achievement type, and the achievement to award.', 'gamipress' ),
            'input_schema'        => array(
                'type'       => 'object',
                'properties' => array(
                    'user' => array(
    ...
    public function execute( $args ) {
        ...
        gamipress_award_achievement_to_user( $achievement->ID, $user->ID );
        ...
        $url_credential = '[' . __( 'credential', 'gamipress' ) . '](' . gamipress_get_credential_url( $achievement->ID, $user->ID ) . ')';
...
new GamiPress_AI_Assistant_Ability_Award_Achievement();